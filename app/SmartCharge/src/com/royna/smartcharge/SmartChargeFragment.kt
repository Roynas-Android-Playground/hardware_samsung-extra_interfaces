...
class SmartChargeFragment : PreferenceFragmentCompat(), CompoundButton.OnCheckedChangeListener {
  ...
  override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
    ...
    restartSwitch.setOnPreferenceChangeListener { _, value ->
      ...
      preferences.edit()
        .putBoolean(PREF_RESTART_ENABLED, enabled)
        .putInt(PREF_RESTART, restartBar.value)
        .apply()
      updateSeekbarTitles()
    ...
    val seekListener = Preference.OnPreferenceChangeListener { preference, value ->
      ...
      preferences.edit().putInt(preference.key, candidate).apply()
      updateSeekbarTitles(mapOf(preference.key to candidate))
